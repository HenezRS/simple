...
import com.henez.simple.atlas.imgs.ImgEnemies32;
...
public enum ImgSetFighters {
    ...
    enemy_octoBig(ImgEnemies32.octobig_idle_0, ImgEnemies32.octobig_idle_1, ImgEnemies32.octobig_attack_0, ImgEnemies32.octobig_attack_1),
    ;
    ...
    TextureRegionEnhanced portrait;
    ...
    ImgSetFighters(ImgEnemies32 idle, ImgEnemies32 idle2, ImgEnemies32 attack, ImgEnemies32 attack2) {
        this.idle = idle.asTex();
        this.idle2 = idle2.asTex();
        this.attack = attack.asTex();
        this.attack2 = attack2.asTex();
        this.isLarge = true;
        this.portrait = idle.asTexPortrait();
    }
